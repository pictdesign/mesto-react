    ...
    >
        <> 
          <label className="popup__field">
              <input ref={placeNameRef} className="popup__input" type="text" placeholder="Название" name="image_name" required minLength="2" maxLength="30 " />
              <span className="popup__input-error" id="image_name-error"></span>
          </label>
          <label className="popup__field"> 
            <input ref={placeLinkRef} className="popup__input" type="url" placeholder="Ссылка на картинку" name="image_link" required />
